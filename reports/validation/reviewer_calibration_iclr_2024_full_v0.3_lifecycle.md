...
| Mean LLM rebuttal label coverage | 27.5% |
| Mean LLM rebuttal addressed rate | 18.7% |
| Mean LLM rebuttal resolved rate | 2.2% |
| Mean meta-review uptake rate | 41.6% |
| Mean claim lifecycle robustness | 57.5% |
| Mean high-robustness claim rate | 10.4% |
| Mean medium/high robustness claim rate | 86.3% |
...
- `claim_lifecycle_robustness_counts`: `{"high": 97, "low": 107, "medium": 650}`
...
- `claim_llm_rebuttal_response_counts`: `{"generic_or_unclear": 70, "likely_resolved": 2, "not_addressed": 105, "specifically_addressed": 63}`
- `claim_llm_rebuttal_effect_counts`: `{"does_not_address": 128, "partially_addresses": 73, "resolved_or_weakened": 8, "unclear": 31}`
