...
The current benchmark packet contains 56 claim items across 3 available audited papers, with three ablation views: `review_only`, `review_manuscript`, and `full_evidence_chain`.

This is enough to test the benchmark machinery and small-sample trends. Reaching 30-50 papers requires running the audit pipeline on more papers with manuscript evidence.

## Pseudo-Expert Calibration

- Pseudo-expert labels: 24
- Exact agreement with system-derived expected labels: 0.0%
- Recommended-action agreement: 100.0%
- Rebuttal-resolution agreement: 54.2%
- Evidence-support agreement: 0.0%
